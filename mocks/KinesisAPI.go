...
func (_m *KinesisAPI) DescribeStreamSummary(ctx context.Context, params *kinesis.DescribeStreamSummaryInput, optFns ...func(*kinesis.Options)) (*kinesis.DescribeStreamSummaryOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// KinesisAPI_DescribeStreamSummary_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DescribeStreamSummary'
type KinesisAPI_DescribeStreamSummary_Call struct {
	*mock.Call
}
...
//   - optFns ...func(*kinesis.Options)
func (_e *KinesisAPI_Expecter) DescribeStreamSummary(ctx interface{}, params interface{}, optFns ...interface{}) *KinesisAPI_DescribeStreamSummary_Call {
	return &KinesisAPI_DescribeStreamSummary_Call{Call: _e.mock.On("DescribeStreamSummary",
		append([]interface{}{ctx, params}, optFns...)...)}
}

func (_c *KinesisAPI_DescribeStreamSummary_Call) Run(run func(ctx context.Context, params *kinesis.DescribeStreamSummaryInput, optFns ...func(*kinesis.Options))) *KinesisAPI_DescribeStreamSummary_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]func(*kinesis.Options), len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *KinesisAPI_DescribeStreamSummary_Call) Return(_a0 *kinesis.DescribeStreamSummaryOutput, _a1 error) *KinesisAPI_DescribeStreamSummary_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *KinesisAPI_DescribeStreamSummary_Call) RunAndReturn(run func(context.Context, *kinesis.DescribeStreamSummaryInput, ...func(*kinesis.Options)) (*kinesis.DescribeStreamSummaryOutput, error)) *KinesisAPI_DescribeStreamSummary_Call {
	_c.Call.Return(run)
	return _c
}
